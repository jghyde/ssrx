...
<div class="<?php print $classes; ?>">
  ...
  <?php if ($attachment_before): ?>
    <div class="attachment attachment-before">
      ...
      <?php if ($rows) : ?>
      <div style="background:linear-gradient(to bottom, rgb(9, 69, 105) 0%, rgb(28, 112, 162) 65%, rgb(9, 69, 105) 100%) repeat scroll 0 0 transparent" id="price-search-facets" class="clearfix">
        ...
        <div id="dashboard-title">Select The Distance:</div>
        <?php $i = 1;
